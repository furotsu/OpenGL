...
Mesh::Mesh(std::vector<Vertex> &vertices, std::vector<unsigned short> &indices, std::vector<Texture> &textures, glm::vec3 translation, glm::vec4 rotation, glm::vec3 scale)
	: m_indexed(true)
{
	m_vertices = vertices;
	m_indices = indices;
...
Mesh::Mesh(std::vector<Vertex>& vertices, std::vector<unsigned short>& indices, std::vector<Texture>& textures, glm::mat4& translation)
{
	m_vertices = vertices;
	m_indices = indices;
	m_textures = textures;
